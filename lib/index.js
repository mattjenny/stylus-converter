...
var KNOWN_FUNCTIONS = ['rgb', 'rgba', 'var', 'calc', 'scale', 'rotate', 'translate', 'linear-gradient', 'rect', 'grayscale', 'translate3d', 'translateX', 'url'];
...
function visitCall(_ref3) {
  ...
  if (MIXINS[name]) {
    ...
    var color2 = name === 'mix' ? _argTokens[1].trim() : name === 'shade' ? '#000000' : '#ffffff';
    var amount = name === 'mix' ? _argTokens[2] : _argTokens[1];
    usePaths['sass:color'] = true;
